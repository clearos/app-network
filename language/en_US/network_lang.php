...
$lang['network_network_mode_wizard_description'] = "Let's get your network up and running. The software is versatile and can be configured in different network roles.  Please select the  that best suits your network.";
...
$lang['network_interfaces_help'] = 'Configuring your network interfaces can be a bit tricky.  In order for the system to reach the Internet, you need at least one network interface configured as external.';
...
$lang['network_lan_help'] = 'In gateway mode, the LAN role is for connecting a local network.  Not much else to say here.';
